...
const langString = { $ref: `${typesId}/LangString5000.mjs` }

export default  {
  $id        : `${classesId}/LString5000.mjs`,
  title      : 'LString5000',
  description: 'SCBD lang mapped string object max length 5000',
  type       : 'object',
  properties : {
    ...
    '@type'   : { const: 'LString5000', default: 'LString5000' },
